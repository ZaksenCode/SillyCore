package me.zaksen.score.api.item

import me.zaksen.score.api.addon.SCoreAddon
import me.zaksen.score.util.ext.toNamespacedKey
 ...
 * It does not actually register any items, only adds event handling for ItemStack containing item_id field in nbt.
 * @see org.bukkit.plugin.Plugin.onLoad
 */
class ItemRegistry(
    private val addons: Set<SCoreAddon>,
    ...
    /**
     * Removes all items in a given register and load again.
     * Use if you needed some sort of reboot.
     */
    fun reloadRegistry() {
