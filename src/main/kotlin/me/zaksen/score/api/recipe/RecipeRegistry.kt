...
/**
 * Utilitarian class, for conveniently adding recipes and revealing them to the player.
 */
class RecipeRegistry(
     ...
     * @see ShapedRecipe
     */
    fun registerShapedRecipe(key: NamespacedKey, recipe: ShapedRecipe) {
     ...
     * @see ShapelessRecipe
     */
    fun registerShapelessRecipe(key: NamespacedKey, recipe: ShapelessRecipe) {
